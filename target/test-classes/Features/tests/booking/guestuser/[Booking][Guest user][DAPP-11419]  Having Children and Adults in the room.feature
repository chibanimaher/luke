#@Android @Ios @Booking
Feature: [Booking][Guest user][DAPP-11419] Having children and adults in the room
  ...
  Scenario: [Booking][Guest user][DAPP-11419] Having children and adults in the room
