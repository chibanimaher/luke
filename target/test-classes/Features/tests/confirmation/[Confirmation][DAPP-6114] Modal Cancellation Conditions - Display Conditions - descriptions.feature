#@Android @Ios @Account
Feature: [Confirmation][DAPP-6114] Modal Cancellation Conditions - Display Conditions - descriptions
  ...
  Scenario: [Confirmation][DAPP-6114] Modal Cancellation Conditions - Display Conditions - descriptions
