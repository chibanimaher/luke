#@Android @Ios @Account
Feature: [Account][BAM][DAPP-13986]Online checkin during the stay
  ...
  Scenario: [Account][BAM][DAPP-13986]Display a future booking
   
    Given set data path "./data/booking/guestuser/OnlineCheckinStay.json"
   ...
   #And I click on the button not now 
