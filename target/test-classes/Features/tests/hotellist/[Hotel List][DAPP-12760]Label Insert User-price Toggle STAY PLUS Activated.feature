#@Android @Ios @Booking
Feature: [Hotel List][DAPP-12760]Label Insert User-price Toggle STAY PLUS Activated
  ...
  #@RETRY_TEST
  @NR_TEST
  Scenario: [Hotel List][DAPP-12760]Label Insert User-price Toggle STAY PLUS Activated
