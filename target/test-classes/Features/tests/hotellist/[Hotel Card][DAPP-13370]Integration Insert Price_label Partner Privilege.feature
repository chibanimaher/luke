#@Android @Ios @Booking
Feature: [Hotel Card][DAPP-13370]Integration Insert Price_label Partner Privilege
  ...
  Scenario: [Hotel Card][DAPP-13370]Integration Insert Price_label Partner Privilege
    Given set data path "./data/hotelcard/HotelCardIntegrationInsertPrice_labelPartnerPrivilege.json"
