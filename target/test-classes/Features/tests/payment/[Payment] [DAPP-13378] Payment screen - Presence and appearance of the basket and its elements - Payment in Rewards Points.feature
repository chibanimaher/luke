#Android @Ios @Booking
Feature: [Payment] [DAPP-13378] Payment screen - Presence and appearance of the basket and its elements - Payment in Rewards Points
  Description : presence and appearence of the basket ans its elements
  ...
  Scenario: [Payment] [DAPP-13378] Payment screen - Presence and appearance of the basket and its elements - Payment in Rewards Points
    Given set data path "./data/booking/guestuser/PresenceElement.json"
