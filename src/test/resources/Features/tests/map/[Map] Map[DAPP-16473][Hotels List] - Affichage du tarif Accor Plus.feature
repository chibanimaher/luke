#@Android @Ios @Account
Feature: [Home Page][DAPP-16473] [Autos-Tests] Map Affichage du tarif Accor Plus
  ...
  Scenario: [Home Page][DAPP-DAPP-16473]  [Autos-Tests] [Home Page][DAPP-DAPP-16468]Map Affichage du tarif Accor Plus.feature
   Given set data path "./data/rateselection/RateSelectionLabelInserUserPriceAccorPlus.json"

    Given I verify that we are in homepage
    And Step/Page1 =========== "Authent" ==========
    And I display Login Page
   ...
   When I fill destination with
      ...
      | ${destination2} | ${destinationiOS} |
    And I do search
    And I click on the hotel map list button
    And I click on the hotel pin Accor Plus
    Then I verify that status Accor Plus is displayed on map card
