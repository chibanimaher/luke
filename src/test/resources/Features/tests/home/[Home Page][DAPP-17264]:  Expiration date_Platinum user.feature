#@Android @Ios @Account
Feature: [Home Page][DAPP-17264]Expiration date_Platinum user
  Description : Expiration date_Platinum user
  ...
  Scenario: [Home Page][DAPP-17264] Expiration date_Platinum user
    Given set data path "./data/booking/guestuser/ExpirationDatePlatinumUser.json"
    ...
    And I click on the Platinum card
