#@Android @Ios @Booking
Feature: [Room selection][DAPP-9399][Multiroom]iOS - Engine -MaxPax 
 ...
 #@NR_TEST
 @SMOKE_TEST
  Scenario: [Room selection][DAPP-9400][Multiroom]iOS - Engine -MaxPax 
    ...
    And I fill room options children with adult
    And I verify the display of the message with maximum children count
    And I fill room options until have zero adult
    And I verify the display of the number of adult
