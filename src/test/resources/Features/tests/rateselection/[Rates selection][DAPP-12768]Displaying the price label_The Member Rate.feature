#@Android @Ios @Booking
Feature: [Rates selection][DAPP-12768]Displaying the price label_The AccorHotels Club
  ...
  Scenario:[Rates selection][DAPP-12768]Displaying the price label_The AccorHotels Club
    Given set data path "./data/rateselection/RateSelectionLabelInserUserPriceAccorHotelsClub.json"
    ...
    Then I verify that status AccorHotels Club is displayed             
